<?php if ( is_singular( 'post' ) || is_page_template( 'page-templates/faqs.php') || is_page_template( 'page-templates/blog.php') || is_page_template( 'page-templates/practice-area.php' ) ) : ?>
